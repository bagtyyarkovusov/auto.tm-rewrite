...
- `AsyncStorage` for locale persistence (`localeStore`) and theme preference persistence (`themeStore`); reserved for future TanStack Query cross-launch persistence
