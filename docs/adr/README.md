...
| [0053](0053-remove-vin-decode-section-from-listing-detail.md) | Remove the VIN decode section from Listing detail (amends ADR-0037 VIN history signal) | Accepted | 2026-09-21 |
